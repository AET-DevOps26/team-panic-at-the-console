...
| 🔴 High   | As a General Team Member I want to be able to have my own account, so that I am assignable to tasks, my comments are traceable, and I get a personalized user experience.                                             | - Users can authenicate themselves, and create accounts<br>- Users can login and logout<br>                                                                                                                        |
