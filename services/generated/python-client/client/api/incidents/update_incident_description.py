...
from ...models.update_description_request import UpdateDescriptionRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/incidents/{incident_id}/description".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UpdateDescriptionRequest): Request to set or clear the incident description. An
