...
from ...models.summary_patch import SummaryPatch
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/incidents/{incident_id}/genai/summary/result".format(
...
def sync_detailed(
    ...
    *,
    ...
    """(internal) Write AI-generated Summary back to incident-service
     ...
     Called by genai-service after an Ollama generation completes.
