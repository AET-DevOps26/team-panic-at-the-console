...
public interface IncidentsApi {
     ...
     * The comment&#39;s authorId is taken from the gateway-injected &#x60;X-User-Id&#x60; header (the validated session identity), never from the request body.
     *
